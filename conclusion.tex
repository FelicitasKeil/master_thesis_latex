We compute the angular power spectra of the AGWB using {\tt MultiCLASS} with a dependence on the measured frequency. We then use this result for an IFT separation with the NIFTy package. 
